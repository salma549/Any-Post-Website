...
const VechilesList = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`http://localhost:5000/vehicles/${formData.category}`, data);
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="post-form">
        ...
        <option value="create1">All</option>

          <option value="cars">Cars</option>
          <option value="motorcycles-scooters">Motorcycles & Scooters</option>
          <option value="trucks-commercial">Trucks & Commercial Vehicles</option>
