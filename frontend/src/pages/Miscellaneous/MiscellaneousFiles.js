  ...
  return (
    <>
      ...
      <div style={styles.container}>
        <h1 style={styles.heading}>Miscellaneous Listings</h1>
        ...
        <li style={styles.categoryItem}><Link to="/miscellaneous/everything-else" style={styles.categoryLink}>Everything Else</Link></li>
<li style={styles.categoryItem}><Link to="/miscellaneous/unique-items" style={styles.categoryLink}>Unique Items</Link></li>
<li style={styles.categoryItem}><Link to="/miscellaneous/barter-trade" style={styles.categoryLink}>Barter & Trade</Link></li>
