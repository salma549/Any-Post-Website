          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Sign up for a free account on Any-Post to start posting
                      and searching for items and services.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container5 thq-card">
              <h2>
                {props.step2Title ?? (
                  <Fragment>
                    <h2 className="steps2-text27 thq-heading-2">Post an Ad</h2>
                  </Fragment>
                )}
              </h2>
              <span>
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      Fill out the ad posting form, upload images of your item
                      or service, and preview how your listing will appear.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Use the search bar, category icons, and filters to find
                      items or services you are interested in.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31 thq-body-small">
                      Access your user dashboard to view &apos;My Ads,&apos;
                      &apos;Saved Listings,&apos; and communicate with other
